...
def everything_for_your_cat(cats_data):
    """
    функция оптимизирует данные по владельцам котиков, собирает словарь по владельцам : котикам и преобразует в строку
    :param cats_data: список кортежей вида ('Кличка кота', возраст, 'Имя', 'Фамилия')
    :return: Строка, каждый уникальный владелец на новой строке
    """
    our_dict = dict()
