...
def to_roman(val):
    """
    функция принимает год, написанный арабскими цифрами, возвращает строку римскими цифрами
    :param val: принимаем год арабскими цифрами, целое число
    :return: возвращаем строку из римских цифр
    """

    roman_numbers = {'M': 1000, 'CM': 900, 'D': 500, 'CD': 400,
                     'C': 100, 'XC': 90, 'L': 50, 'XL': 40,
                     'X': 10, 'IX': 9, 'V': 5, 'IV': 4, 'I': 1}
# при сокращении словаря до 1, 5, 10, 50, 100, 500, 1000 не нашел решения, но словарь уменьшил от исходного в 2 раза

    roman_str = ''
    for letter, arabic in roman_numbers.items():
        while val >= arabic:
            roman_str += letter
            val -= arabic
    return roman_str
