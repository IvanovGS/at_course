...
def to_roman(val):
    """
    функция принимает год, написанный арабскими цифрами, возвращает строку римскими цифрами (работает до 4000г)
    :param val: принимаем год арабскими цифрами, целое число
    :return: возвращаем строку из римских цифр
    """
    roman_dict = dict([(1, 'I'), (2, 'II'), (3, 'III'), (4, 'IV'), (5, 'V'), (6, 'VI'), (7, 'VII'), (8, 'VIII'), (9, 'IX'),
    ...
    while val > 0:
        ...
        letter = val - val % l
        val = val % l
        roman_str += roman_dict.get(letter)
    return roman_str
