...
def repeats(our_str):
    """
    генерируем строку, показывающую, сколько раз каждый символ уже встречался, в формате letter_n
    где letter - символ, n - кол-во вхождений до выбранного символа
    :param our_str:
    строка
    :return:
    строка с кол-вом вхождений каждого символа с начала строки
    """
    new_str = ''
