...
def letter_stat(our_str):
    """
    формируем словарь, где ключ - буква строки, значение - кол-во вхождений данной буквы в подстроку
    :param our_str: строка для создания словаря
    :return: словарь
    """
    letters_dict = {our_str[letter]: our_str.count(our_str[letter]) for letter in range(len(our_str))}
    return letters_dict
